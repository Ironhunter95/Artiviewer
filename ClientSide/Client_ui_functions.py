...
class ClientUIFunctions(ClientWindow):
    ...
    def addNewMenu(self, name, objName, icon, isTopMenu):
        ...
        button.setFont(font)
        button.setStyleSheet(ClientStyles.style_bt_standard.replace('ICON_REPLACE', icon))
        button.setText(name)
    ...
    def selectStandardMenu(self, widget):
        for w in self.ui.frame_left_menu.findChildren(QPushButton):
            if w.objectName() == widget:
                w.setStyleSheet(ClientUIFunctions.selectMenu(w.styleSheet()))

    ## ==> RESET SELECTION
    def resetStyle(self, widget):
        for w in self.ui.frame_left_menu.findChildren(QPushButton):
            if w.objectName() != widget:
                w.setStyleSheet(ClientUIFunctions.deselectMenu(w.styleSheet()))
    ...
    def uiDefinitions(self):
        def dobleClickMaximizeRestore(event):
            ...
            if event.type() == QtCore.QEvent.MouseButtonDblClick:
                QtCore.QTimer.singleShot(250, lambda: ClientUIFunctions.maximize_restore(self))
        ...
        ## ==> MAXIMIZE/RESTORE
        self.ui.btn_maximize_restore.clicked.connect(lambda: ClientUIFunctions.maximize_restore(self))
